...
On the first face-analysis request, InsightFace may download the `buffalo_l` model. CPU matching works for an MVP but large galleries should use background processing and a vector database.
